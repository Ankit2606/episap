...
const MYNFT = ({i,image,description,tokenId,parentId,name,acknowledge}) => {
  ...
  return (
    ...
    >
      ...
      <CardContent className="miniCard">
        ...
        <Typography gutterBottom variant="body1" component="div">
          <span style={{ fontWeight: 900 }}>Name</span> : {name}
        </Typography>
      ...
      <CardActions>
        <Button size="small" onClick={() => openModal(tokenId)}>
          Create Leaf
        </Button>
        <Button size="small" onClick={() => openModal1(tokenId)}>
          Create Poll
        </Button>
        <Button 
          size="small"
